...
var styles = {
    listReader: 'listReader_5d4d298a',
    container: 'container_5d4d298a',
    row: 'row_5d4d298a',
    column: 'column_5d4d298a',
    'ms-Grid': 'ms-Grid_5d4d298a',
    title: 'title_5d4d298a',
    subTitle: 'subTitle_5d4d298a',
    description: 'description_5d4d298a',
    button: 'button_5d4d298a',
    label: 'label_5d4d298a',
};
...
// module
exports.push([module.i, ".listReader_5d4d298a .container_5d4d298a{max-width:700px;margin:0 auto;box-shadow:0 2px 4px 0 rgba(0,0,0,.2),0 25px 50px 0 rgba(0,0,0,.1)}.listReader_5d4d298a .row_5d4d298a{margin:0 -8px;box-sizing:border-box;color:\"[theme:white, default: #ffffff]\";background-color:\"[theme:themeDark, default: #005a9e]\";padding:20px}.listReader_5d4d298a .row_5d4d298a:after,.listReader_5d4d298a .row_5d4d298a:before{display:table;content:\"\";line-height:0}.listReader_5d4d298a .row_5d4d298a:after{clear:both}.listReader_5d4d298a .column_5d4d298a{position:relative;min-height:1px;padding-left:8px;padding-right:8px;box-sizing:border-box}[dir=ltr] .listReader_5d4d298a .column_5d4d298a{float:left}[dir=rtl] .listReader_5d4d298a .column_5d4d298a{float:right}.listReader_5d4d298a .column_5d4d298a .ms-Grid_5d4d298a{padding:0}@media (min-width:640px){.listReader_5d4d298a .column_5d4d298a{width:83.33333333333334%}}@media (min-width:1024px){.listReader_5d4d298a .column_5d4d298a{width:66.66666666666666%}}@media (min-width:1024px){[dir=ltr] .listReader_5d4d298a .column_5d4d298a{left:16.66667%}[dir=rtl] .listReader_5d4d298a .column_5d4d298a{right:16.66667%}}@media (min-width:640px){[dir=ltr] .listReader_5d4d298a .column_5d4d298a{left:8.33333%}[dir=rtl] .listReader_5d4d298a .column_5d4d298a{right:8.33333%}}.listReader_5d4d298a .title_5d4d298a{font-size:21px;font-weight:100;color:\"[theme:white, default: #ffffff]\"}.listReader_5d4d298a .description_5d4d298a,.listReader_5d4d298a .subTitle_5d4d298a{font-size:17px;font-weight:300;color:\"[theme:white, default: #ffffff]\"}.listReader_5d4d298a .button_5d4d298a{text-decoration:none;height:32px;min-width:80px;background-color:\"[theme:themePrimary, default: #0078d4]\";border-color:\"[theme:themePrimary, default: #0078d4]\";color:\"[theme:white, default: #ffffff]\";outline:transparent;position:relative;font-family:Segoe UI WestEuropean,Segoe UI,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,sans-serif;-webkit-font-smoothing:antialiased;font-size:14px;font-weight:400;border-width:0;text-align:center;cursor:pointer;display:inline-block;padding:0 16px}.listReader_5d4d298a .button_5d4d298a .label_5d4d298a{font-weight:600;font-size:14px;height:32px;line-height:32px;margin:0 4px;vertical-align:top;display:inline-block}", ""]);
